...
export default function HomePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-sky-50 to-indigo-50 text-slate-800">
      {/* Navbar */}
      <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <Building className="h-6 w-6 text-indigo-600" />
            <span className="text-xl font-bold bg-gradient-to-r from-indigo-600 to-sky-500 bg-clip-text text-transparent">AccommoFind</span>
          </div>
      ...
      <main className="flex-1">
        ...
        {/* Search Section */}
        <section className="container relative -mt-24 z-30">
          <Card className="shadow-lg border-0 rounded-xl overflow-hidden">
            <CardContent className="p-6">
              <Tabs defaultValue="all" className="w-full">
                <TabsList className="mb-6 grid w-full grid-cols-3 bg-slate-100 p-1">
                  <TabsTrigger value="all" className="flex items-center gap-2 data-[state=active]:bg-white data-[state=active]:text-indigo-600">
                    <Building className="h-4 w-4" />
                    <span>All</span>
                  </TabsTrigger>
                  <TabsTrigger value="hotels" className="flex items-center gap-2 data-[state=active]:bg-white data-[state=active]:text-indigo-600">
                    <Hotel className="h-4 w-4" />
                    <span>Hotels</span>
                  </TabsTrigger>
                  <TabsTrigger value="homes" className="flex items-center gap-2 data-[state=active]:bg-white data-[state=active]:text-indigo-600">
                ...
                <TabsContent value="all" className="mt-0">
                  <div className="grid gap-4 md:grid-cols-4">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input placeholder="Where are you going?" className="pl-9 border-slate-200 focus:border-indigo-300 focus:ring-indigo-200" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button variant="outline" className="w-full justify-start text-left font-normal border-slate-200 hover:bg-slate-50 hover:text-indigo-600">
                    ...
                    <div className="space-y-2">
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button variant="outline" className="w-full justify-between text-left font-normal border-slate-200 hover:bg-slate-50 hover:text-indigo-600">
                        ...
                        <PopoverContent className="w-80 bg-white" align="start">
                          <div className="grid gap-4 p-2">
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center gap-2">
                                <Button variant="outline" size="icon" className="h-8 w-8 border-slate-200 text-slate-700">
                                  -
                                </Button>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button variant="outline" size="sm" className="h-8 border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-indigo-600">
                          Price Range
                      ...
                      <PopoverContent className="w-80 bg-white">
                        <div className="space-y-4 p-2">
                          ...
                          <div className="px-2">
                            <Slider defaultValue={[50, 250]} min={0} max={500} step={10} className="[&>span]:bg-indigo-500" />
                          </div>
                          <div className="flex items-center justify-between">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-80 bg-white">
                        <div className="grid grid-cols-2 gap-2 p-2">
                          <Button variant="outline" className="justify-start border-slate-200 text-slate-700 hover:bg-indigo-50 hover:text-indigo-600 hover:border-indigo-200">
                            Hotel
                          </Button>
                          <Button variant="outline" className="justify-start border-slate-200 text-slate-700 hover:bg-indigo-50 hover:text-indigo-600 hover:border-indigo-200">
                            Apartment
        ...
        <section className="container py-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-indigo-600 to-sky-500 bg-clip-text text-transparent">Featured Accommodations</h2>
            <Button variant="outline" className="border-indigo-200 text-indigo-600 hover:bg-indigo-50 hover:border-indigo-300">View all</Button>
          </div>
        ...
        <section className="bg-gradient-to-br from-indigo-50 to-sky-100 py-16">
          <div className="container">
            <h2 className="text-3xl font-bold tracking-tight mb-8 bg-gradient-to-r from-indigo-600 to-sky-500 bg-clip-text text-transparent">Popular Destinations</h2>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {["New York", "Paris", "Tokyo", "London"].map((city) => (
                <div key={city} className="relative h-40 rounded-xl overflow-hidden group shadow-md transition-all duration-300 hover:shadow-xl">
                  <Image
        ...
        {/* Testimonials */}
        <section className="container py-16">
          <h2 className="text-3xl font-bold tracking-tight text-center mb-12 bg-gradient-to-r from-indigo-600 to-sky-500 bg-clip-text text-transparent">What Our Users Say</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="text-center p-6 shadow-sm border-0 bg-white rounded-xl hover:shadow-md transition-all">
        ...
        <section className="bg-gradient-to-r from-indigo-600 to-sky-500 py-16">
          <div className="container text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary" onClick={() => setShowLoginModal(true)}
        ...
        {/* How It Works */}
        <section className="container py-16">
          <h2 className="text-3xl font-bold tracking-tight text-center mb-12 bg-gradient-to-r from-indigo-600 to-sky-500 bg-clip-text text-transparent">How AccommoFind Works</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input placeholder="Your email" className="h-9 border-slate-200 focus:border-indigo-300 focus:ring-indigo-200" />
                <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white">Subscribe</Button>
              </div>
            </div>
          </div>
      ...
      <Dialog open={showLoginModal} onOpenChange={setShowLoginModal}>
        <DialogContent className="sm:max-w-md bg-white">
          ...
          <div className="flex flex-col gap-4 py-4">
            <Button onClick={() => setShowLoginModal(false)} className="bg-indigo-600 hover:bg-indigo-700 text-white">Log In</Button>
            <Button variant="outline" onClick={() => setShowLoginModal(false)} className="border-slate-200 text-slate-800 hover:bg-slate-50 hover:text-indigo-600">
              Sign Up
            </Button>
          </div>
        </DialogContent>
